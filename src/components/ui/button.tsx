  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-base font-semibold ring-offset-background transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-5 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Therapeutic CTA variants
        cta: "bg-[hsl(340_50%_55%)] text-[hsl(0_0%_100%)] font-bold shadow-elevated hover:shadow-glow hover:scale-[1.02] active:scale-[0.98] hover:bg-[hsl(340_55%_50%)]",
        "cta-outline": "border-2 border-primary-deep bg-transparent text-primary-deep hover:bg-primary-deep hover:text-[hsl(0_0%_100%)]",
        soft: "bg-blush-soft text-foreground hover:bg-primary/20",
      },
      size: {
